...
func (ColorSys) Rgb2Yiq(r, g, b uint32) (float64, float64, float64) {
	r1 := float64(r) / 255
	g1 := float64(g) / 255
	b1 := float64(b) / 255
...
func (ColorSys) Yiq2Rgb(y, i, q float64) (uint32, uint32, uint32) {
...
func (ColorSys) Rgb2Hls(r, g, b uint32) (float64, float64, float64) {
	var h, l, s float64
	r1 := float64(r) / 255
	g1 := float64(g) / 255
	b1 := float64(b) / 255
...
func (ColorSys) Hls2Rgb(h, l, s float64) (uint32, uint32, uint32) {
	var m1, m2 float64
	if s == 0.0 {
...
func (ColorSys) Rgb2Hsv(r, g, b uint32) (float64, float64, float64) {
	var h, s, v float64
	r1 := float64(r) / 255
	g1 := float64(g) / 255
	b1 := float64(b) / 255
...
func (ColorSys) Hsv2Rgb(h, s, v float64) (uint32, uint32, uint32) {
	h /= 360
	if s == 0.0 {
...
func (cs *ColorSys) Yiq2Hls(y, i, q float64) (float64, float64, float64) {
	r, g, b := cs.Yiq2Rgb(y, i, q)
	return cs.Rgb2Hls(r, g, b)
}

func (cs *ColorSys) Yiq2Hsv(y, i, q float64) (float64, float64, float64) {
	r, g, b := cs.Yiq2Rgb(y, i, q)
	return cs.Rgb2Hsv(r, g, b)
}

func (cs *ColorSys) Hls2Yiq(h, l, s float64) (float64, float64, float64) {
	r, g, b := cs.Hls2Rgb(h, l, s)
	return cs.Rgb2Yiq(r, g, b)
}

func (cs *ColorSys) Hls2Hsv(h, l, s float64) (float64, float64, float64) {
	r, g, b := cs.Hls2Rgb(h, l, s)
	return cs.Rgb2Hsv(r, g, b)
}

func (cs *ColorSys) Hsv2Yiq(h, s, v float64) (float64, float64, float64) {
	r, g, b := cs.Hsv2Rgb(h, s, v)
	return cs.Rgb2Yiq(r, g, b)
}

func (cs *ColorSys) Hsv2Hls(h, s, v float64) (float64, float64, float64) {
	r, g, b := cs.Hsv2Rgb(h, s, v)
	return cs.Rgb2Hls(r, g, b)
}

// Convert RGB values to Hex (uint32)
func (ColorSys) RGBToHex(r uint32, g uint32, b uint32) uint32 {
...
func (ColorSys) RGBAToHex(r uint32, g uint32, b uint32, a uint32) uint32 {
	return ((r & 0xff) << 24) + ((g & 0xff) << 16) + ((b & 0xff) << 8) + (a & 0xff)
}

// Hex2RGB converts a hexadecimal color string (e.g. #FFCC66) to RGB
func (ColorSys) Hex2RGB(color string) (int, int, int) {
